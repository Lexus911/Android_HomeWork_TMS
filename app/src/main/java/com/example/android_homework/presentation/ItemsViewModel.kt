...
class ItemsViewModel: ViewModel() {
        ...
        fun getData() {
            ...
            val listItems = listOf<ItemsModel>(
                ItemsModel(
                    R.drawable.we_are_the_champions, "We are the champions", "Album: New of the World - 1977", time,
                    R.drawable.white_star
                ),
                ItemsModel(
                    R.drawable.we_will_rock_you, "We will rock you", "Album: New of the World - 1977", time,
                    R.drawable.white_star
                ),
                ItemsModel(
                ...
                ItemsModel(
                    R.drawable.bohemian_rhapsody, "We are the champions", "Album: A night at the Opera - 1975", time,
                    R.drawable.white_star
                ),
                ItemsModel(
                    R.drawable.the_show_must_go_on, "We are the champions", "Album: Innuendo - 1991", time,
                    R.drawable.white_star
                )
            )
