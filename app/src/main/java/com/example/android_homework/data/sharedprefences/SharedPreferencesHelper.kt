package com.example.android_homework.data.sharedprefences
...
class SharedPreferencesHelper @Inject constructor(private val sharedPreferences: SharedPreferences) {
    ...
    fun getUserCreads(): UserModel{
       val name = sharedPreferences.getString(USER_NAME, "") ?: "NO VALUE"
       val password = sharedPreferences.getString(USER_PASSWORD, "") ?: "NO VALUE"
